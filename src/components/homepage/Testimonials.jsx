...
const Testimonials = () => {
    ...
    return (
        <>
            <div className='px-40 py-10 gap-10 flex flex-col bg-[#B1977C]'>
                <h1 className='text-white playfair-display-font font-bold text-4xl text-center'>Hear From Our Customers</h1>
                ...
                >
                    <div className=' flex justify-center'>
                        <p className='text-white font-medium text-lg text-center max-w-4xl '>
            ...
            {/* footer */}
            <div className='mx-40 my-10 gap-10 flex flex-col justify-center items-center bg-[#253359] rounded-2xl py-10'>
                <p className='text-2xl font-semibold text-white text-center max-w-md px-5'>Craft Your Dream Team With Us
                    to Excel Beyond Limits!</p>
                    <button className='bg-white text-[#253359] rounded-3xl py-2.5 px-5 text-md w-fit'>Book a Call</button>
            </div>
        </>
    )
}
